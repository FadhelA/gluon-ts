...
class MyDeepAREstimator(GluonEstimator):
    ...
    *Note:* the code of this model is unrelated to the implementation behind
    `SageMaker's MyDeepAR Forecasting Algorithm
    ...
    def create_training_network(self) -> MyDeepARTrainingNetwork:
        return MyDeepARTrainingNetwork(
    ...
    def create_predictor(
        ...
        prediction_network = MyDeepARPredictionNetwork(
