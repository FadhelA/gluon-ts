...
class MyDeepARNetwork(mx.gluon.HybridBlock):
    @validated()
    def __init__(
        self,
        num_layers: int,
    ...
    def distribution(
        ...
        take_last_n_timesteps: Optional[int] = None,
    ) -> Distribution:
        """
...
class MyDeepARTrainingNetwork(MyDeepARNetwork):
    ...
    def hybrid_forward(
        ...
        """
        Computes the loss for training MyDeepAR, all inputs tensors representing
...
class MyDeepARPredictionNetwork(MyDeepARNetwork):
    @validated()
